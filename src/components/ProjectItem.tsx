  ...
  return (
    <div className="relative group rounded-lg hover:bg-gray-50">
      ...
      >
        ...
        <div className="p-2">
          <p className="pointer-events-none mt-2 block truncate text-sm font-medium text-gray-900 group-hover:underline">
            {project.name}
          </p>
      ...
      <Menu as="div" className="absolute top-4 right-4">
        {({ open }) => (
          <>
            ...
            >
              <MenuItem>
                <button className="group flex w-full items-center gap-2 rounded-lg py-1.5 px-3 data-[focus]:bg-white/10 cursor-default select-none">
